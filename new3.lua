-- ScoopHub V2.6 exact-source GUI library (Readable User Text + Transparent Logo)
...
local Library={Unloaded=false,Build="SCOOPHUB_V2_6_READABLE_USER_TEXT"}
 ...
 function window:AddTab(c)
  ...
  function tab:AddUserDashboard(u)
   ...
   local function row(par,t,v,y)
    ...
    local x=label(par,v,UDim2.new(.32,4,0,y),UDim2.new(.68,-16,0,17),12,T.White,T.Body,Enum.TextXAlignment.Right)
   ...
   label(lc,"WalkSpeed Value",UDim2.new(0,12,0,31),UDim2.new(1,-24,0,14),11,T.Muted,T.Font)
   local wi=C(N("TextBox",{Text=tostring(q.WalkSpeedValue or 16),PlaceholderText="16",ClearTextOnFocus=false,Font=T.Font,TextSize=12,TextColor3=T.White,
