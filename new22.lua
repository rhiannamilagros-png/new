...
function Library:CreateWindow(cfg)
 ...
 -- Close confirmation modal. The X button requests a close instead of immediately
 -- destroying ScoopHub. This keeps the behavior consistent across every script
 -- that uses this library while still allowing cfg.CloseConfirm=false to opt out.
 ...
 local CloseConfirmBox=C(N("Frame",{
  ...
  AnchorPoint=Vector2.new(.5,.5),
  Position=UDim2.fromScale(.5,.5),
  Size=UDim2.fromOffset(270,132),
  BackgroundColor3=T.Panel,
  BackgroundTransparency=.03,
  BorderSizePixel=0,
  ZIndex=301
 },CloseConfirmHolder),8)
 gradient(CloseConfirmBox,T.Surface3,T.Bg,16)
 S(CloseConfirmBox,T.Red,.16,1.25)

 local CloseConfirmScale=N("UIScale",{Scale=.92},CloseConfirmBox)

 local CloseConfirmAccent=C(N("Frame",{
  Name="Accent",
 ...
 CloseConfirmText.Name="Description"
 ...
 local CloseConfirmCancel=C(N("TextButton",{
  ...
  Position=UDim2.new(0,16,1,-15),
  Size=UDim2.new(.5,-22,0,34),
 ...
 S(CloseConfirmAccept,Color3.fromRGB(255,92,104),.38,1)
 ...
 local function showClosePrompt()
  ...
  CloseConfirmScale.Scale=.92
  tw(CloseConfirmHolder,{BackgroundTransparency=.38},.14)
  tw(CloseConfirmScale,{Scale=1},.18)
 end
 ...
 local function hideClosePrompt()
  ...
  tw(CloseConfirmHolder,{BackgroundTransparency=1},.12)
  tw(CloseConfirmScale,{Scale=.96},.12)
