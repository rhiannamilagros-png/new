-- ScoopHub V2.8 exact-source GUI library (Compact Preference Text + Refined Typography)
...
local Library={Unloaded=false,Build="SCOOPHUB_V2_8_COMPACT_PREFERENCE_TEXT"}
